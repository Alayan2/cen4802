...
public class Main {
	...
	/**
	 * Prints a statement declaring the fibonacci value for the int input.
	 * 
	 * @param a long value of place in fibonacci sequence 
	 * @param b long value of the fibonacci sequence
	 * 
	 * @return String statement
	 */
	public static String printOutput(long a, long b) {
		
		return "The " + a + "th term of the Fibonacci sequence is " 
				+ b + ".\n";
	}
}
